  ...
  return (
    <div style={styles.wrap}>
      ...
      <div style={styles.header}>
        ...
        <div className="header-nav" style={{ display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 6, padding: "6px 12px", background: ACCENTS.green + "15", border: `1px solid ${ACCENTS.green}40`, borderRadius: 8 }}>
            ...
            <span style={{ fontSize: 10, fontWeight: 900, color: ACCENTS.green, fontFamily: "'DM Mono', monospace" }}>SYSTEM LIVE</span>
          </div>
          <ThemeBtn dark={isDark} toggle={toggleTheme} />
          <NavBtn label="관리자 페이지" emoji="⚙️" color={ACCENTS.purple} onClick={() => window.location.href = "/super-admin"} />
          <NavBtn label="수익화 세팅" emoji="💰" color={ACCENTS.amber} onClick={() => window.location.href = "/monetization"} />
        </div>
      </div>
