...
const KO_EN_MAP: Record<string, string> = {
  ...
  // ── 환경/에너지 ──
  환경: "nature environment green eco leaf clean air, no people",
  환경보호: "environmental protection green earth recycle symbols, no people",
  재활용: "recycling bins sorted waste paper plastic glass, no people",
  분리수거: "waste separation recycling bins sorted garbage, no people",
  탄소중립: "carbon neutral eco energy wind solar green, no people",
  친환경: "eco friendly green products natural organic, no people",
  에너지: "energy electricity power lines solar wind turbine, no people",
  태양광: "solar panels rooftop energy renewable, no people",
  태양에너지: "solar energy panels sun technology renewable, no people",
  풍력: "wind turbines energy farm renewable field, no people",
  전기에너지: "electric energy power grid cables, no people",
  절전: "energy saving switch plug electricity bill, no people",
  // ── 정치/사회 ──
  정치: "government building capitol dome national flag, no people",
  선거: "ballot box voting election paper democracy, no people",
  국회: "parliament building national assembly architecture, no people",
  정책: "policy document government paper official stamp, no people",
  사회: "community society urban city life, no people",
  복지: "welfare care service support document, no people",
  사회복지: "social welfare care document community support, no people",
  // ── 생활용품/가정 ──
  생활용품: "household daily items products bottles containers, no people",
  주방용품: "kitchen utensils cookware pots pans tools, no people",
  가전제품: "home appliances electronics refrigerator washing machine, no people",
  청소용품: "cleaning supplies spray bottle mop sponge, no people",
  세탁: "laundry washing machine detergent folded clothes, no people",
  가구: "furniture home interior sofa desk chair, no people",
  침구: "bedding pillow blanket cozy bedroom, no people",
  욕실용품: "bathroom products soap shampoo towel, no people",
  // ── 농업/수산물/식재료 ──
  농업: "agriculture farm field crop harvest tractor, no people",
  농산물: "farm produce vegetables fruits harvest basket, no people",
  수산물: "seafood fresh fish market display, no people",
  해산물: "seafood shellfish fresh market display, no people",
  굴비: "dried yellow corvina fish korean traditional food, no people",
  한우: "korean beef wagyu meat butcher display, no people",
  유기농: "organic farming vegetables natural fresh produce, no people",
  // ── 레저/스포츠 ──
  골프: "golf course green club ball equipment, no people",
  테니스: "tennis court racket ball net equipment, no people",
  수영: "swimming pool water lane lane ropes, no people",
  낚시: "fishing rod lake river nature water, no people",
  등산: "hiking trail mountain path equipment backpack, no people",
  자전거: "bicycle bike road outdoor cycling trail, no people",
  레저: "leisure outdoor activity equipment nature, no people",
  // ── 정신건강/웰니스 ──
  명상: "meditation cushion candle calm peaceful nature, no people",
  수면: "sleep cozy bed pillow night lamp, no people",
  스트레스: "stress relief nature calm tea candle, no people",
  마음건강: "mental wellness calm nature journal tea, no people",
  // ── 공예/취미/원예 ──
  원예: "gardening plants flower pot soil tools, no people",
  정원: "garden flowers plants nature landscape, no people",
  DIY: "diy tools wood craft workshop materials, no people",
  공예: "craft handmade materials tools clay fabric, no people",
  베이킹: "baking bread cake oven flour mixing bowl, no people",
  사진: "photography camera lens equipment studio, no people",
  // ── 식품/음료 ──
  비건: "vegan plant based food vegetables healthy bowl, no people",
...
export default function ImageGenerator() {
  ...
  const autoTranslatePrompt = async (koreanPrompt: string, variation: number = 0): Promise<string> => {
    ...
    if (aiKey) {
      try {
        const aiPrompt = `You are a blog thumbnail image expert.
Look at this Korean blog title and create ONE English image prompt.
The image must make viewers instantly understand what the blog is about — just by looking at it.
No people, no faces, no text, no letters. Photorealistic. Natural lighting. 20 words max.
