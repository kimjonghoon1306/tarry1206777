...
import { userGet, SETTINGS_KEYS, syncAdminSettingsToLocal, addNotification } from "@/lib/user-storage";
...
- 한글, 영어, 숫자만 사용`;
      ...
      addNotification("keyword", "키워드 수집 완료", `AI 키워드 ${newKWs.length}개 추천됨`);
    } catch (e: any) {
  ...
  async function doCollect(query?: string) {
    ...
    try {
      ...
      addNotification("keyword", "키워드 수집 완료", `네이버 키워드 ${newKWs.length}개 수집됨`);
    } catch(e:any) {
